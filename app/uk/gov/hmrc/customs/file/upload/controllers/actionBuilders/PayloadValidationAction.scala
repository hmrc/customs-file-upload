...
import uk.gov.hmrc.customs.file.upload.model.actionbuilders.{AuthorisedRequest, ValidatedFileUploadPayloadRequest}
import uk.gov.hmrc.customs.file.upload.services._
...
abstract class PayloadValidationAction(val xmlValidationService: XmlValidationService,
  ...
  extends ActionRefiner[AuthorisedRequest, ValidatedFileUploadPayloadRequest] {
